...
{
    [JokerStaticDescription(staticId: 11, JokerRarity.Common, 3, Description = "If hand played is Pair, +50 Chips.")]
    ...
    [JokerStaticDescription(staticId: 12, JokerRarity.Common, 4, Description = "If hand played is Three of a Kind, +100 Chips.")]
    ...
    [JokerStaticDescription(staticId: 13, JokerRarity.Common, 4, Description = "If hand played is Two Pair, +80 Chips.")]
    ...
    [JokerStaticDescription(staticId: 14, JokerRarity.Common, 4, Description = "If hand played is Straight, +100 Chips.")]
    ...
    [JokerStaticDescription(staticId: 15, JokerRarity.Common, 4, Description = "If hand played is Flush, +80 Chips.")]
    ...
    [JokerStaticDescription(staticId: 16, JokerRarity.Common, 5, Description = "If 3 or fewer cards are played, +20 Mult.")]
    ...
    [JokerStaticDescription(staticId: 17, JokerRarity.Uncommon, 8, Description = "X1 Mult for each empty Joker slot. (This Joker does not count)")]
    public class JokerStencil : JokerObject
    {
        ...
        public override void OnCardTriggerDone(GameContext ctx, ref ScoreContext scoreCtx)
        {
            var emptySlots = ctx.JokerContainer.AvailableSlots +
    ...
    [JokerStaticDescription(staticId: 18, JokerRarity.Uncommon, 7, Description = "Allows Flushes and Straights to be made with 4 cards.")]
    ...
    [JokerStaticDescription(staticId: 19, JokerRarity.Uncommon, 5, Description = "Retrigger all card held in hand abilities 1 additional time.")]
    ...
    [JokerStaticDescription(staticId: 20, JokerRarity.Common, 1, Description = "Allows to go up to -20 gold in debt")]
    public class CreditCard : JokerObject
    {
        ...
        {
            ctx.PersistentState.EconomyHandler.ActivateCreditCardJoker();
        }
        ...
        public override void OnRemove(GameContext ctx)
        {
            ...
            {
                ctx.PersistentState.EconomyHandler.DisableCreditCardJoker();
            }
        }
